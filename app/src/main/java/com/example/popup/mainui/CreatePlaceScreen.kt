...
@Composable
fun CreatePlaceScreen(navController: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            PopUpTextField(labelText = "Enter a location",
            ...
            Row {
                PopUpSecondaryButton(onClick = {navController.navigate(CREATE_TIME_SCREEN)}, text = "Back")
                PopUpPrimaryButton(onClick = {navController.navigate(CREATE_MISC_SCREEN)}, text = "Next")
            }
        }
...
fun CreatePlaceScreenPreview() {
    CreatePlaceScreen(navController = rememberNavController())
}